...
var database = "atwoodi26";  //database name
var user = "atwoodi26";         //username (change to match your db)
var password = "AVNQUHCILGZ";  //password (change to match your db, yes THIS IS VERY POOR PRACTICE)
